...
public class GraphiteMRCounterExecutorExecutorTestImplicitMapping {
        ...
        server = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    graphiteData = new String(receivePacket.getData(), 0, receivePacket.getLength(), Charsets.UTF_8);
                    serverSocket.close();
        ...
        server = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    int length = connectionSocket.getInputStream().read(receiveData);
                    graphiteData = new String(receiveData, 0, length, Charsets.UTF_8);
    ...
    private void runTestUDP(int port, String fileName, String... ExpectedgraphiteData) throws IOException,
            ActionExecutorException, InterruptedException {
        setupUDP(port);

        final String configuration = Resources.toString(Resources.getResource(this.getClass(), fileName),
                Charsets.UTF_8);
    ...
    @Test
    public void testGraphiteMRCounterExecutor_with_implicit_mapping() throws ActionExecutorException, IOException,
            InterruptedException {

        runTestUDP(2005, "GraphiteMRCounterExecutor_with_implicit_mapping.xml", new String[] {
                "graphite-prefix.counter1 1234 1369263600", "graphite-prefix.counter2 56 1369263600" });
